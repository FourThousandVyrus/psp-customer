...
import { ArrowRight, Eye, EyeOff, Mail, Lock, Loader2, CheckCircle2 } from 'lucide-react';
          ...
          <div className="hidden lg:block space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-600">
                Sign in to manage your payments and grow your business
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Monitor your transactions and revenue as they happen</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Understand your customers and their payment patterns</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Track performance with detailed reports and charts</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-gray-700 mb-3 italic">
                    "Links Payments has transformed how we accept mobile money. The dashboard is intuitive and the API is super easy to integrate."
                  </p>
                  <div>
                    <p className="font-semibold text-gray-900">Kwame Mensah</p>
                    <p className="text-sm text-gray-600">CEO, TechShop Ghana</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 sm:p-10">
              ...
              <div className="lg:hidden mt-8 pt-8 border-t border-gray-200 text-center">
                <p className="text-sm text-gray-600">
                  Need help? <Link href="#" className="text-green-600 hover:text-green-700 font-medium">Contact support</Link>
                </p>
              </div>
            </div>
          </div>
